...
# Update and support pet projects
...
In basic usage, there were no issues, but due to exceeding free-tier limits, complications started to appear. Additionally, working with Heroku has become more complicated — more details can be found <a href="https://blog.heroku.com/next-chapter" target="_blank">here</a>.
